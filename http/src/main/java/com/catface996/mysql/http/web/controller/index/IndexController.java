package com.catface996.mysql.http.web.controller.index;

import java.net.InetAddress;

import com.catface996.common.model.JsonResult;
import com.catface996.mysql.http.config.propertis.DemoProperties;
...
public class IndexController {
    ...
    public JsonResult<String> index() {
        ...
        String message = "Hello,这里是 theone example.IP:" + ip + ",env:" + env;
        log.info(message);
