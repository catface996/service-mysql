package com.catface996.mysql.service.goods.impl;
...
import com.catface996.mysql.service.goods.convert.GoodsConvert;
...
public class GoodsServiceImpl implements GoodsService {
    ...
    private void continueDoSomeThings() {
        log.error("这里仅仅模拟打印异常", new Catface996Exception(CommonErrorEnum.PARAM_ERROR));
    }
}
