package com.catface996.mysql.repository.generator;
...
import com.catface996.mysql.BaseTest;
...
public class GeneratorServiceEntity extends BaseTest {
    ...
    private final String packageName = "com.catface996.example.repository";
    ...
    public void generateOnlyEntity() {
        generateEntity(serviceNameStartWithI, packageName, "student");
    }
